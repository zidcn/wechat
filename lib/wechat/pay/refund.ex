defmodule WeChat.Pay.Refund do
  ...
  @doc """
  退款申请 -
  [官方文档](https://pay.weixin.qq.com/doc/v3/merchant/4013071036){:target="_blank"}
  ...
  @doc """
  查询单笔退款(通过商户退款单号) -
  [官方文档](https://pay.weixin.qq.com/doc/v3/merchant/4013071041){:target="_blank"}
  ...
  @doc """
  发起异常退款 -
  [官方文档](https://pay.weixin.qq.com/doc/v3/merchant/4013071193){:target="_blank"}
